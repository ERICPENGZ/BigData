...
//      }
        ...
        //多个输入
        MultipleInputs.addInputPath(job,new Path("/user/master/data/text.txt"),TextInputFormat.class,maper.class);
        MultipleInputs.addInputPath(job,new Path("/user/master/data/1.seq"),SequenceFileInputFormat.class,seq_maper.class);
